...
### Intelligent Inventory A Time Series Analysis and LSTM Optimization.
...
example_product <-'Headphones'  # change to an actual SKU value in your data

ts_sku <- daily_prepared %>%
  filter( product == 'Headphones') %>%
  arrange(date)
...
ggplot(ts_sku, aes(x = date, y = demand)) +
  geom_line(color = "steelblue") +
  labs(
    title = paste("Daily Demand for", 'headphones'),
    x = "Date", y = "Units Sold"
  ) +
  theme_minimal()
